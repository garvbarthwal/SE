    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <Dialog open={batchOpen} onOpenChange={setBatchOpen}>
        <DialogContent className="max-w-6xl">
          <DialogHeader>
            <DialogTitle>Batch Edit Meals</DialogTitle>
            <DialogDescription>
              Edit every visible meal in one table and add extra historical entries before saving.
            </DialogDescription>
          </DialogHeader>

          <div className="space-y-4">
            <div className="flex items-center justify-between gap-3">
              <p className="text-sm text-slate-500">Editing {batchRows.length} meal row{batchRows.length === 1 ? '' : 's'} from {filterLabel}.</p>
